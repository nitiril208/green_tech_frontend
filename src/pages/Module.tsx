...
import { MdKeyboardArrowUp, MdPlayCircleOutline } from "react-icons/md";
import { RiArrowDownSLine, RiCloseLine, RiMenuLine } from "react-icons/ri";
import { VscDeviceCameraVideo, VscFilePdf } from "react-icons/vsc";
            ...
            {activeTab === "tab2" && (
              <div className="p-4">
                <div className="border-b border-[#D9D9D9] pb-3">
                  ...
                  <p className="text-[#606060] text-[12px] ml-1">
                ...
                <div className="border-b border-[#D9D9D9] pb-4 mt-3">
                  ...
                  <p className="text-[#606060] text-[12px] ml-2">
                    Section: 2 | Duration: 00:30:00
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between bg-white py-4 border-b border-[#D9D9D9]">
                  <div className="flex items-center">
                    ...
                    <div className="ml-2">
                      ...
                      <p className="text-[#606060] text-[12px]">
                        Date : 29th march, 2024 | Time: 9:10AM
                      </p>
                    </div>
                  </div>
                  <button className="bg-[#00778B] text-white px-4 py-1 rounded-md text-sm h-[42px] w-[110px]">
